   ...
   Properties
    {
        ...
        _SpecularNum("SpecularNum",Range(0,100))=10
    ...
    SubShader//切线空间下计算法线贴图
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //diffus颜色
                float halfLambertNum=dot(tangentNormal, normalize(i.lightDir))*0.5+0.5;
                float3 lambertColor=_LightColor0*albedo*tex2D(_RampTex,fixed2(halfLambertNum,halfLambertNum));
