	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_16_0 = ( texCoord15.x + ( tex2D( _NoiseTex, panner6 ).r * _NoiseIntensity ) );
				...
				float4 appendResult23 = (float4(tex2D( _MianTex, ( appendResult17 + appendResult10 ) ).r , tex2DNode4.g , tex2D( _MianTex, ( appendResult17 + appendResult11 ) ).b , tex2DNode4.a));
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-2102.997,660.8348;Inherit;False;Property;_NoiseIntensity;NoiseIntensity;4;0;Create;True;0;0;0;False;0;False;0.1491136;0;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;11;-1124.85,768.4854;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;10;-1244.327,564.2386;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector4Node;13;-1700.24,701.8339;Inherit;False;Property;_RG_Offset;RG_Offset;3;0;Create;True;0;0;0;False;0;False;0.03,0,-0.03,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;24;-1380.726,25.21147;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.5;False;4;FLOAT;0.5;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F43B02C22C13BC6128B2A0FB2A159B9727AA7EA5